...
CUDA_VISIBLE_DEVICES=0 python main_train.py --experiment_name=iWGAN_generate --mode=generate --recover_model=False --batch_size=64 --crop_size=64 --learning_rate=0.0002  --use_two_stream=False  --root_dir=../frames-stable-many --index_file=golf.txt
